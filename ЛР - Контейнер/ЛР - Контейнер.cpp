...
int main()
{
    ...
    MyTimer time;
    mas.pushIn(10, 2);
    std::cout << "Duration of pushIn: " << time.duration() << "\n";
    std::cout << mas << std::endl;
    ...
    std::cout << "\nDuration of while: " << time.duration() << "\n";

    std::cout << "Семантика копирования\n";
    time.reset();
    MyArray<int> mas2(mas);
    std::cout << "Продолжительность семантики копирования: " << time.duration() << "\n";
    std::cout << "Mas2: " << mas2 << "\nMas: " << mas << "\n";
    std::cout << "\n";

    std::cout << "Семантика перемещения\n";
    time.reset();
    MyArray<int> mas3(std::move(mas));
    std::cout << "Продолжительность семантики перемещения: " << time.duration() << "\n";
    std::cout << "Mas3: " << mas3 << "\nMas: " << (mas.isEmpty() ? "Empty" : "Not empty") << "\n";
